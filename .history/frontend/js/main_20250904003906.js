...
// import { initHeaderFeatures } from "./header.js";
/**
 * Sticky Header
 */
...
window.addEventListener("DOMContentLoaded", async () => {
  ...
  try {
    ...
    // Core UI
    // initTasks.push(initHeaderFeatures());
...
/**
 * After-load behaviors for special components
 */
function postInitComponent(fileName) {
...
function initHeader() {
  ...
  // Auth area state (temporary stub, later link with real login)
  initAuthArea();
}

function initAuthArea() {
  const loggedIn = false; // TODO: plug in your real auth logic
