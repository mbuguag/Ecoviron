...
const API_BASE_URL = isLocalDev
  ...
  : isPreviewEnv
    ? "https://preview.ecoviron.com/api"
    : "https://www.ecoviron.com/api";

const STATIC_BASE_URL = isLocalDev
  ? "http://localhost:5500"
  : isPreviewEnv
    ? "https://preview.ecoviron.com/static"
    : "https://www.ecoviron.com/static";

const BASE_PATH = isLocalDev ? "" : isPreviewEnv ? "/preview" : "";

// Log environment details (only local)
if (DEBUG) {
...
const config = {
  ...
  STATIC_BASE_URL,
  BASE_PATH,
  COMPONENTS_BASE: `${STATIC_BASE_URL}/components/`,
};
/**
