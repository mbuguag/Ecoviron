...
document
  ...
  .addEventListener("click", () => toggleWishlist(product.id));
...
function renderRelatedProducts(products) {
 ...
 async function toggleWishlist(productId) {
   ...
   if (!token) {
     ...
     showToast("Saved to wishlist (guest mode)");
     return;
   }
   ...
   try {
     ...
     if (res.ok) showToast("Added to wishlist!");
     else throw new Error("Wishlist add failed");
   } catch (err) {
