...
const API_BASE_URL = isLocalDev
  ...
  : `${window.location.origin}${BASE_PATH}api`;
...
const config = {
  COMPONENTS_BASE: isLocalDev ? "./components/" : `${STATIC_BASE_URL}/components/`
};
 ...
 */
function getAssetPath(relativePath, bustCache = false) {
 ...
 */
async function loadComponent(fileName, containerId, maxRetries = 3) {
