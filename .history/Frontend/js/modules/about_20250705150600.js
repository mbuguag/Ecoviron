...
export function initAboutSection() {
  return fetch(`${API_BASE_URL}/about`)
    ...
    .then((data) => {
      if (Array.isArray(data) && data.length > 0) {
        ...
        // Split into paragraphs at full stops followed by capital letter (basic heuristic)
  ...
  const keywords = ["Bionix-ESH Limited", "Environmental Management", "Occupational Health and Safety", "WASH", "Wastewater Treatment Systems"];
  keywords.forEach(kw => {
