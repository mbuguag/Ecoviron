...
export function initBreadcrumbs() {
  ...
  const breadcrumbMap = {
    ...
    // Ecommerce section
     "ecommerce/product-grid.html": { title: "Shop", parent: "index.html" },
  "ecommerce/product-details.html": { title: "Product Details", parent: "ecommerce/product-grid.html" },
  "ecommerce/cart.html": { title: "Cart", parent: "ecommerce/product-grid.html" },
  "ecommerce/checkout.html": { title: "Checkout", parent: "ecommerce/cart.html" },
  "ecommerce/order-success.html": { title: "Order Success", parent: "ecommerce/checkout.html" },
  "ecommerce/wishlist.html": { title: "Wishlist", parent: "ecommerce/product-grid.html" },
  ...
  // Insert after header (fallback: top of body)
