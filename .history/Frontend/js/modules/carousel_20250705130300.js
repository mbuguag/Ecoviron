...
export function initCarousel() {
  ...
  const services = [
    ...
    { title: "Environmental Audits", image: "assets/images/reelbed-wastewater.png" },
    { title: "Environmental Assessment", image: "assets/images/hero-bg.png" }
  ];
  ...
  function updateProgressBar() {
    ...
    if (progressBar) {
      ...
      const progress = ((Math.floor(currentIndex / itemsPerView()) + 1) / total) * 100;
