...
export async function loadLayoutComponents() {
  ...
  console.log('BASE_PATH:', BASE_PATH);
   ...
   try {
    const headerUrl = resolvePath('components/header.html');
    const footerUrl = resolvePath('components/footer.html');
    ...
    console.log('Header load result:', headerResult);
    console.log('Footer load result:', footerResult);
