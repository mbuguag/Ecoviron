import { loadComponent, resolvePath } from './utils.js';

export async function loadLayoutComponents() {
  try {
    const [header, footer] = await Promise.all([
      loadComponent('Frontend/components/header.html', 'header-container'),
      loadComponent('Frontend/components/footer.html', 'footer-container')
    ]);
