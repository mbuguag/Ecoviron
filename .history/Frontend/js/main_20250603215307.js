...
const pathParts = window.location.pathname.split('/').filter(part => part && !part.includes('.html'));
  ...
  const consultancyServices = [
    {
      ...
      link: "services/eia.html" // Changed to relative path since these are in services/ folder
    },
    {
