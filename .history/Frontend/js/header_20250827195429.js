class HeaderManager {
  ...
  toggleMobileMenu() {
    ...
    this.isMenuOpen ? this.openMobileMenu() : this.closeMobileMenu();
  }
  ...
  setupMobileDropdowns() {
    ...
    mobileDropdowns.forEach(link => {
      link.addEventListener('click', (e) => {
        ...
        // Close ALL open dropdowns (mobile + desktop)
        this.closeAllDropdowns();

        if (!isActive) {
          dropdown.classList.add('active');
          document.dispatchEvent(new CustomEvent("dropdownToggled", {
            detail: { key, open: true, source: "mobile" }
          }));
        }
      });
    });
  ...
  setupDesktopDropdowns() {
    this.dropdowns.forEach(dropdown => {
      ...
      dropdown.addEventListener('mouseenter', () => {
        ...
        this.closeAllDropdowns(); // close everything first
  ...
  // 🔒 Close ALL dropdowns (both desktop + mobile)
  closeAllDropdowns() {
    document.querySelectorAll('.mobile-nav .dropdown.active')
      .forEach(d => d.classList.remove('active'));
    document.querySelectorAll('.site-header .dropdown .dropdown-content')
