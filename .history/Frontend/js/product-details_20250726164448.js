// product-details.js
import { addToCart, updateStickyBar } from "./cart-actions.js";
import { API_BASE_URL } from "./main.js"; // Adjust if needed
...
function renderProductDetail(product) {
  ...
  mainImage.src = `${API_BASE_URL}/uploads/${product.mainImage}`;
