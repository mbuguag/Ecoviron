...
import {loadQuoteModal} from "../frontend/js/modules/quote-modal.js"
window.addEventListener("DOMContentLoaded", async () => {
  try {
    ...
    // Queue component initializations based on DOM
    ...
    // Auth display area (login/logout toggle)
    ...
    // Load quote modal only if relevant button exists
    if (document.querySelector('[data-toggle="quote-modal"]')) {
      await loadQuoteModal();
    }

    // Fallback header and footer if loading fails
