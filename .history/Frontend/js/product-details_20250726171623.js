...
import { API_BASE_URL, getQueryParam, formatPrice } from "./apiConfig.js";
...
function renderProductDetail(product) {
  ...
  mainImage.src = `${API_BASE_URL}/uploads/${product.imageUrl}`;
...
function renderRelatedProducts(products) {
  ...
  products.forEach((product) => {
    ...
    card.innerHTML = `
      <img src="${API_BASE_URL}/uploads/${product.imageUrl}" alt="${
      product.name
    }" />
      <h4>${product.name}</h4>
