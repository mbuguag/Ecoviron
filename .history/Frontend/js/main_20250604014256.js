...
function resolvePath(relativePath) {
  ...
  // Remove file name if present (e.g., contact.html, eia.html)
  if (segments[segments.length - 1].includes('.html')) {
    segments.pop();
  }

  const depth = segments.length - 1; // subtract 1 for leading slash
...
console.log("Header path:", resolvePath('components/header.html'));
console.log("Footer path:", resolvePath('components/footer.html'));