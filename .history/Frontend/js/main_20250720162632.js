...
window.addEventListener("DOMContentLoaded", async () => {
  ...
  initTasks.push(initNewsletter());
    ...
    if (header && header.innerHTML.trim() === "") {
      header.innerHTML = `<header class="default-header"><a href="/">Bionix</a></header>`;
    }
...
function addChatFab() {
  ...
  fab.href = "https://wa.me/254712345678"; // Replace with your WhatsApp number
  fab.target = "_blank";
  fab.className = "chat-fab";
  fab.innerHTML = `<img src="assets/icons/whatsapp.svg" alt="Chat" />`;
