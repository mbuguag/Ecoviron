...
/**
 * Single source of truth: layout initialization
 */
const layoutInitPromise = (async () => {
  try {
...
export const layoutLoaded = layoutInitPromise;
...
window.addEventListener("DOMContentLoaded", async () => {
  ...
  const layoutOk = await layoutInitPromise;
  ...
  // Continue with app init regardless of fallback
  renderUserDropdown();
  const initTasks = [];
