import { API_BASE, authFetch } from "../../js/utils.js";
...
function openModal(post = null) {
  ...
  if (post) {
    ...
    document.getElementById("publish-date").value = post.publishedAt ? post.publishedAt.slice(0, 16) : "";
