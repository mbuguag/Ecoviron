...
export const API_BASE = {
  ...
  // 🔄 Cloudinary upload endpoint (handled by backend)
  uploadImage: `${API_BASE_URL}/images/upload`,

  // ✅ Explicit images base (not local /uploads anymore)
  images: "https://res.cloudinary.com/<your-cloud-name>/image/upload/",
