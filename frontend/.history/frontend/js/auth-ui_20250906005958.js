/**
 * auth-ui.js
 * - Provides initAuthUI() entry point
 * - Renders Login/Register dropdown for guests OR user dropdown for logged-in users
 * - Reads state from localStorage (jwtToken, userRole, username, userEmail, profileImage)
 */
