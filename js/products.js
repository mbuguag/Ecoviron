...
/* -----------------------------
   JSON-LD Schema (One Array)
--------------------------------*/
function injectSchema(products) {
  const head = document.head;
  document.querySelectorAll('script[data-schema="products"]').forEach((el) => el.remove());
  ...
  script.textContent = JSON.stringify({ "@context": "https://schema.org", "@graph": schema }, null, 2);
