...
const layoutState = { initialized: false, headerLoaded: false, footerLoaded: false };
const domCache = { header: null, footer: null, menuToggle: null, navMenu: null };
...
function loadFallbackFooter() {
  ...
  const year = new Date().getFullYear();
  domCache.footer.innerHTML = `<footer class="fallback-footer"><p>© ${year} BIONIX-EHS. All rights reserved.</p></footer>`;
}
